  ...
  var history = useHistory();
   ...
   <div className="container successmodal" style={{"textAlign":"center","width":"80%","margin":"10%"}}>
     <img src={success} style={{"width":"20%"}} />
         ...
         <p> We have sent you the brochure on the provided email.  </p>
...
<p>We will send you the brochure on the email provided by you.</p>
      ...
      <input type="text" class="form-control" id="email"  name="name" required  onChange={(e)=>{setName(e.target.value)}} value={name}  />
    </div>
    
    <div className="form-group">
      <label for="email">Company:</label>
      <input type="text" class="form-control" id="email"  name="company" onChange={(e)=>{setCompany(e.target.value)}} value={company} required/>
    </div>
